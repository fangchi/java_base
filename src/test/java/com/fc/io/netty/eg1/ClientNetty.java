...
import com.fc.io.netty.ClientHandler;
...
//                  socketChannel.pipeline().addLast(MarshallingCodefactory.buildEncoder());
        ...
        // 发送客户端的请求
        cf.channel().writeAndFlush(Unpooled.copiedBuffer(reqStr.getBytes(Charset.forName("utf8"))));
//      Thread.sleep(300);
...
//      cf.channel().writeAndFlush(student);
    ...
    public static void main(String[] args) throws UnsupportedEncodingException, InterruptedException {
        new ClientNetty("127.0.0.1", 8088).action();
    }
}
